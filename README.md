...
## Progress: Project 11 Complete

I finished the second half of the **Compiler**. This part takes the structured Jack code from Project 10 and turns it into working Virtual Machine (VM) code.

## Progress: Project 12 Complete

I built the **Operating System (OS)** using the Jack programming language. This is a collection of code libraries that helps programs talk to the hardware easily without rewriting basic logic every time.

- **Math & Memory:** Wrote code to handle multiplication, division, and basic math. I also built a system to manage and allocate RAM space dynamically.
- **Graphics & Text:** Created algorithms to draw lines, circles, and pixels on the screen, as well as a library to display text characters.
- **User Input & Tools:** Developed services to read keyboard presses, manage strings, and handle system errors gracefully.
